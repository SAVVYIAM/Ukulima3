...
<body>
  ...
  <input type="text" id="area" style="margin-left:100px;border-radius:5px;border-color:blue;" onkeyup="myFunction()" placeholder="Filter customers by area...">
	<table style="width: 90%;margin-left: 70px;border-collapse: collapse;" id="customers">
...
<?php
            ...
            <br>
       			<p align="center" style="font-size: 20px"><b><i>Sorry! No Customers registered</i></b></p>
            <?php
       		}
       		$conn->close();
