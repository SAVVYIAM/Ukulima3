...
<body>
  ...
  <input type="text" id="orderid" style="margin-left:100px;border-radius:5px;border-color:blue;" onkeyup="myFunction()" placeholder="Filter Farmers by order id...">
	<table style="width: 90%;margin-left: 70px;border-collapse: collapse;" id="sales">
...
<td bgcolor="#FFFFFF"><?php echo $row['Service_cost']; ?></td>
